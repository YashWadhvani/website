      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-8 relative">
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              {/* Circle */}
              <div className="relative z-10 w-20 h-20 mx-auto rounded-full bg-white shadow-lg border border-[var(--border-light)] flex items-center justify-center transition-all duration-300 group-hover:shadow-xl group-hover:scale-105">
