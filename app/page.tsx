...
export default function Home() {
    ...
    return (
        <div>
            ...
            <section className="relative overflow-hidden py-28 bg-[var(--background)]">
                {/* Background Glow */}
                <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="container relative z-10">
                    ...
                    >
                        {exportStats.map((stat) => (
                            <div
                                key={stat.label}
                                className="bg-[var(--off-white)] border border-[var(--border-light)] rounded-2xl p-6 text-center shadow-sm"
                            >
